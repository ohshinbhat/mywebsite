    ...
    <div className=''>
        <div className='flex flex-col gap-20 font-sans2 py-5 text-white'>
            <div className='flex flex-col gap-4 w-full'>
                ...
                <motion.div id='container' variants={container} initial="hidden" whileInView="visible" exit="visible" viewport={{ amount: 0.0000001, once: true }} className='  px-[30px] sm:px-[75px] grid-cols-1 md:grid-cols-3 grid justify-center items-center gap-5'>
                    ...
                    <motion.a href='https://github.com/ohshinbhat/cryptoX' target='_blank' id='item' variants={item}  className='flex h-full flex-col gap-3 w-full px-10 py-4 rounded-lg backdrop-filter backdrop-blur-lg bg-mygray text-white font-extralight border-creme border-[1px] items-center justify-center'>
                    ...
                    <motion.a href='https://github.com/ohshinbhat/Rewire' target='_blank' id='item' variants={item}  className='flex h-full flex-col gap-3 w-full px-10 py-4 rounded-lg backdrop-filter backdrop-blur-lg bg-mygray text-white font-extralight border-creme border-[1px] items-center justify-center'>
                    ...
                    <motion.a href='https://github.com/ohshinbhat/AI_summarizer' target='_blank' id='item' variants={item} className='flex h-full flex-col gap-3 w-full px-10 py-4 rounded-lg backdrop-filter backdrop-blur-lg bg-mygray text-white font-extralight border-creme border-[1px] items-center justify-center'>
                    ...
                    <motion.a id='item' href='https://github.com/ohshinbhat/skin-sense-api-new' target='_blank' variants={item} className='flex h-full flex-col gap-3 w-full px-10 py-4 rounded-lg backdrop-filter backdrop-blur-lg bg-mygray text-white font-extralight border-creme border-[1px] items-center justify-center'>
                    ...
                    <motion.a id='item' variants={item} className='flex h-full flex-col gap-3 w-full px-10 py-4 rounded-lg backdrop-filter backdrop-blur-lg bg-mygray text-white font-extralight border-creme border-[1px] items-center justify-center'>
